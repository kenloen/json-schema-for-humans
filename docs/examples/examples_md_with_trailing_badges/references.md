...
### <a name="anchor_with_slash_propertyA"></a>3.1. `root > anchor_with_slash > propertyA` ![Optional](https://img.shields.io/badge/Optional-yellow)![type: string](https://img.shields.io/badge/type-string-4c72b0)
